        ...
        <div className='mt-16 mb-16 min-h-screen'>
            ...
            </div>
            {
                myOrders.map((order, index) => (
                    <div key={index} className='border border-gray-300 rounded-lg mb-10 p-4 py-5 w-full'>
                        ...
                        {order.items.map((item, index) => (
                            <div key={index}
                                ...
                                <p className='text-lg font-medium text-primary'>Aomunt: Rs.{item.product.offerPrice * item.quantity}</p>
                            </div>
                        ))}
                    </div>
                ))
